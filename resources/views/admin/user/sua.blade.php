	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-lg-7" style="padding-bottom:120px">
				...
				@endif 
				<form action="index.php/admin/user/sua/{{$user->id}}" method="POST">
					...
					<div class="form-group">
						...
						<input type="password" class="form-control password" name="password" placeholder="Nhập MK" disabled="" />
					</div>
					<div class="form-group">
						<label>Nhập lại Password</label>
						<input type="password" class="form-control password" name="passwordAgain" placeholder="Nhập lại MK" disabled="" />
					</div>
					<div class="form-group">
